...
Светодиоды:
- VD19 - показывает активность протокола общения с МК БСП. 
         Меняет состояние при каждом приеме сообщения. Если связи нет, не горит.
- VD20 - показывает активность протокола Modbus. 
         Меняет состояние при каждом приеме сообщения. Если связи нет, не горит.
