...
${TESTDIR}/tests/runnerBsp.o: tests/runnerBsp.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runnerBsp.o tests/runnerBsp.cpp


${TESTDIR}/tests/testBsp.o: tests/testBsp.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testBsp.o tests/testBsp.cpp


${TESTDIR}/tests/runnerDR.o: tests/runnerDR.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runnerDR.o tests/runnerDR.cpp


${TESTDIR}/tests/testDR.o: tests/testDR.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testDR.o tests/testDR.cpp
